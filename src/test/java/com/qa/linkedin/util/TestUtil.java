...
public static String captureScreenshot(String methodName) throws IOException {
		log.debug("capturescreenshot(string methodname); is invoking!!!");
	...
	private static String getScreenshotName(String methodName) {
		log.debug("getting the screenshot name for "+methodName);
		log.debug("create object for date class for screenshot" );
		Date d = new Date();
